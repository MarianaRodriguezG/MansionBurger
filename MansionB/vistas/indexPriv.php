        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
          <div class="col-lg-8">
            ...
            <p class="text-white-50">
              ...
              Ya sea en familia, con amigos o solo, Nikos es el lugar perfecto para saborear momentos inolvidables.
        ...
        <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
          ...
          <div class="col-xl-4 col-lg-5">
            <div class="featured-text text-center text-lg-left">
              <h4>Bebidas</h4>
              <p class="text-black-50 mb-0">En Nikos, cada comida se complementa con nuestras bebidas refrescantes, desde limonadas caseras hasta refrescantes sodas artesanales.
              ...
              <div class="d-flex h-100">
                <div class="project-text w-100 my-auto text-center text-lg-left">
                  ...
                  <p class="mb-0 text-white-50">Preparamos nuestras hamburguesas con carne de primera calidad y los ingredientes más frescos para ofrecerte una experiencia de sabor inigualable.
                    Cada hamburguesa en Nikos es una obra maestra, desde la clásica hasta la más innovadora, diseñada para satisfacer tus antojos más exigentes.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
          <div class="col-lg-8">
            ...
            <p class="text-white-50">
              ¿Listo para disfrutar de una experiencia culinaria inolvidable en Nikos?
