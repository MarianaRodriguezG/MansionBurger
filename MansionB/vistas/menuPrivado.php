        ...
        <div class="container-fluid justify-content-center justify-content-md-between">
            <div class="d-flex my-2 my-sm-0">
                ...
                <form class="d-flex input-group w-auto my-auto">
                    <input autocomplete="off" type="search" class="form-control rounded" placeholder="Buscar" style="min-width: 125px" />
            ...
            <form class="d-flex col-4" action="cerrarSesion.php">
                <span class="navbar-text me-3"><?php echo htmlspecialchars($_SESSION["rol"]); ?></span>
                <button class="btn btn-light" type="submit"><i class="fas fa-sign-out-alt"></i> Salir</button>
            </form>
        </div>
    </nav>
</header>
