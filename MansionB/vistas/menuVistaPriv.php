...
<section class="about-section text-center" id="about">
  <div class="container px-4 px-lg-5">
      <div class="row gx-4 gx-lg-5 justify-content-center">
          <div class="col-lg-8">
              <h2 class="text-white mb-4">El Menú de Nikos´s</h2>
              <p class="text-white-50">
              Bienvenido a Nikos, donde los sabores auténticos se mezclan con la pasión por la cocina. Sumérgete en una experiencia gastronómica única con nuestras deliciosas creaciones que te transportarán a los rincones más exquisitos de Moroleón, Gto.
              </p>
          </div>
      </div>
  </div>
    ...
    <div class="container my-4">
      ...
      <div class="row">
        <div class="col-lg-4 text-center">
          ...
          <p><a class="btn btn-secondary" href="ordenaAqui.php">Ver detalles &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4 text-center">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading fw-normal lh-1">La Gran  <span
              class="text-body-secondary">Hamburguesa Nikos:</span></h2>
          <p class="lead">
Sumérgete en una experiencia de sabor con nuestra Gran Hamburguesa Nikos. 
...
Cada mordida es una explosión de sabores que te hará volver por más.
      ...
      <div class="row">
        <div class="col-md-7 order-md-2">
          <h2 class="fw-normal lh-1">Limonada Refrescante <span class="text-body-secondary">de la Casa:</span></h2>
          <p class="lead">
Refréscate con nuestra Limonada Refrescante de la Casa. Hecha con limones frescos y un toque justo de dulzura,
 es la bebida perfecta para acompañar tu comida y mantenerte fresco durante todo el día.</p>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading fw-normal lh-1">Brownie con <span
              class="text-body-secondary">Helado Nikos:</span></h2>
          <p class="lead">Termina tu comida con una nota dulce con nuestro Brownie con Helado Nikos.
 Un decadente brownie de chocolate, servido caliente y acompañado de una bola de helado de vainilla.
