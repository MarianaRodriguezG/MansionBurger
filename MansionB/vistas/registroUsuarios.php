...
if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
    ...
    //Validar los datos
    if (strlen($usuario->nombre) >= 2 && strlen($usuario->nombre) <= 30 &&
        strlen($usuario->apellido1) >= 2 && strlen($usuario->apellido1) <= 30 &&
        (strlen($usuario->apellido2) == 0 || 
        (strlen($usuario->apellido2) >= 2 && strlen($usuario->apellido2) <= 30)) &&
        (strlen($usuario->telefono) == 0 || 
        preg_match("/^[0-9]{10}$/", $usuario->telefono)) &&
        preg_match("/^[\w\-.]+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/", $usuario->correo) &&
...
<div class="container pt-4">
    <form id="frmRegistro" novalidate method="post" action="registroUsuarios.php" class="<?=$validado?>">
        <div class="row">
            ...
            <div class="mb-2 col-4">
                ...
                <div>El segundo apellido debe tener entre (entre 2 y 30 caracteres)</div>
            </div>
            ...
            <div class="mb-2 col-6">
                ...
                <select name="cboRol" id="cboRol" name="cboRol" class="form-select" required>
            ...
            <fieldset class="col-12 border rounded p-3 mb-2">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="rbtGenero" id="rbtMasculino" value="M" checked>
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="rbtIndeterminado">
                        Indeterminado
                    </label>
                </div>
            </fieldset>
    ...
    <div class="alert alert-danger alert-dismissible fade show">
        El usuario no se ha podido almacenar. Intente nuevamente con un correo diferente. <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
    <?php
    }
    ...
    ?>
    <div class="alert alert-danger alert-dismissible fade show">
        El correo ya está registrado. Use un correo diferente. <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
    <?php
    }
    ?>
